...
federations/certs/test/ca.crt: federations/certs/test/ca.key
	openssl req -new -x509 -key federations/certs/test/ca.key -out federations/certs/test/ca.crt -config federations/certs/test/ca.conf
​
federations/certs/test/local.csr: 
	openssl req -new -keyout federations/certs/test/local.key -out federations/certs/test/local.csr -config federations/certs/test/local.conf -subj /CN=$(full_hostname)
​
