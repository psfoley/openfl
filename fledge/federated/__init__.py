...
if pkgutil.find_loader('torch') and pkgutil.find_loader('tensorflow'):
    from .task import FastEstimatorTaskRunner, FederatedModel  # NOQA
    from .data import FastEstimatorDataLoader, FederatedDataSet  # NOQA
elif pkgutil.find_loader('tensorflow'):
...
elif pkgutil.find_loader('torch'):
