...
import collaborator_aggregator_interface_pb2 as collaborator__aggregator__interface__pb2
...
class Aggregator(object):
    ...
    def RequestJob(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/tfedlrn_proto.Aggregator/RequestJob',
    ...
    def DownloadModel(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/tfedlrn_proto.Aggregator/DownloadModel',
    ...
    def UploadLocalModelUpdate(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/tfedlrn_proto.Aggregator/UploadLocalModelUpdate',
    ...
    def UploadLocalMetricsUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/tfedlrn_proto.Aggregator/UploadLocalMetricsUpdate',
