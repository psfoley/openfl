...
class AggregatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTasks = channel.unary_unary(
                '/Aggregator/GetTasks',
                request_serializer=lowlevelstrawman__pb2.TasksRequest.SerializeToString,
                response_deserializer=lowlevelstrawman__pb2.TasksResponse.FromString,
                )
...
def add_AggregatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetTasks': grpc.unary_unary_rpc_method_handler(
                    servicer.GetTasks,
                    request_deserializer=lowlevelstrawman__pb2.TasksRequest.FromString,
                    response_serializer=lowlevelstrawman__pb2.TasksResponse.SerializeToString,
            ),
...
class Aggregator(object):
    ...
    def GetTasks(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Aggregator/GetTasks',
            lowlevelstrawman__pb2.TasksRequest.SerializeToString,
            lowlevelstrawman__pb2.TasksResponse.FromString,
    ...
    def GetAggregatedTensor(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Aggregator/GetAggregatedTensor',
            lowlevelstrawman__pb2.TensorRequest.SerializeToString,
            lowlevelstrawman__pb2.TensorResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
