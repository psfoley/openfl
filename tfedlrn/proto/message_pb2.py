...
_AGGREGATOR = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Query',
    full_name='tfedlrn_proto.Aggregator.Query',
    index=0,
    containing_service=None,
    input_type=_FLMESSAGE,
    output_type=_FLMESSAGE,
    serialized_options=None,
  ),
])
